...
.controller('LoginCtrl', function($scope, LoginService, $ionicPopup, $state,$stateParams, $ionicSideMenuDelegate, $http) {
    $scope.data = {};
...
//alert("=="+$scope.itemfish.fishname);

    }

        $scope.itemfish=[
        {name:$scope.itemfish.fishname,id:$scope.itemfish.fishid,price:$scope.itemfish.fishprice}
